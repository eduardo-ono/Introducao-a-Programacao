/*
Programa      : animação-instrução-do-while
Versão        : 1.0
Descrição     : Simula a execução de uma instrução "do-while".
Desenvolvedor : Eduardo Ono
Criado em     : 02/05/2022
Atualizado em : 02/05/2022
Comentários   : Para fins didáticos. Plataforma Windows.
*/
...
int main()
{
    ...
    for (i = 0; i < N; i++)
    {
        for (int j = 0; j < NUM_CODIGOS_LOOP - 1; j++)
        {
        ...
        desenharBorda(codigos_loop[2]);
        input(posAtual);
        removerBorda(codigos_loop[2]);
    }
    // Borda do return
